...
$people = mysqli_query($connect, "SELECT * FROM `user` WHERE `id_user`='$id' ");
		...
		foreach ($people as $people) {
            ...
            ?>   <div class="obsh">
<form style="display:flex; line-height:40px;" action="../../inc/people/update_user.php" method="post" enctype="multipart/form-data">
            <p>
           ...
           <input class="input-update" name="dateborn" type="text" value="<?=$people[2]?>">
            ...
            <!-- <img src="../../<?=$people[3]?>" alt=""> -->
             <input class="input-update" type="hidden" name="status" value="<?=$people[4]?>">
